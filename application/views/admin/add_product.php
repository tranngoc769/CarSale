                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="example-number-input" class="col-md-2 col-form-label">Giá khuyến mãi</label>
                                <div class="col-md-10">
                                    <input class="form-control"  id="sale_price"  value="0"   type="number" step="50000">
                                </div>
                            </div>
                            <div class="form-group row">
